...
shinyUI(fluidPage(
  ...
  tabsetPanel(
    tabPanel("Description",
             ...
             tags$hr(),
             tags$footer("App developed by: "),
             tags$footer(a("Jackie Hatala Matthes", href="http://matthesecolab.com"),", Assistant Professor of Biological Sciences, Wellesley College (2018)",
                         p("Get the source code for this app on",a("GitHub", href = "https://github.com/jhmatthes/evolution-populations")),
                         p(" "),
